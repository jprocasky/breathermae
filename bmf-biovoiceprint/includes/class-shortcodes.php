...
class BMF_BioVoice_Shortcodes {
	...
	public static function shortcode_session( $atts ) {
		...
		return '<div class="' . esc_attr( $class ) . '" data-bmf-biovoice-session data-purpose="' . esc_attr( $purpose ) . '">' 
			. '<div data-wizard-panel><p class="bmf-bv-empty">Loading session…</p></div></div>';
	}
