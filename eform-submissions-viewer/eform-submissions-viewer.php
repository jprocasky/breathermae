...
class EForm_Submissions_Viewer {
    ...
    public function enqueue_assets() {
        ...
        wp_localize_script('eform-js', 'eform_ajax', [
            ...
            'can_send'     => current_user_can('edit_posts') ? 1 : 0,
        ]);
                    ...
                    <div class="eform-modal-content">
                        ...
                        <div class="eform-modal-body">
                            ...
                            <div id="eform-cta-fields" style="display:none;">
                                ...
                                <input type="text" id="eform-cta-text" class="eform-input" placeholder="e.g. Schedule a call">
                                <label for="eform-cta-url">Button URL</label>
                                <input type="url" id="eform-cta-url" class="eform-input" placeholder="https://...">
                            </div>
                        </div>
    ...
    public function ajax_send_reply() {
        ...
        if (!current_user_can('edit_posts')) {
            wp_send_json_error('You do not have permission to send emails.');
        }
