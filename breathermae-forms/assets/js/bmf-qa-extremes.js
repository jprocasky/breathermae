(function () {
  ...
  function exportPdf() {
    ...
    html +=
      '.pdf-footer{margin-top:28px;padding-top:12px;border-top:1px solid #cbd5e1;font-size:10px;color:#64748b;text-align:center;line-height:1.5;}';
    ...
    var genStr = genDate.toLocaleDateString(undefined, {
      year: 'numeric',
      month: 'long',
      day: 'numeric'
    });
    ...
    html +=
      '<div class="pdf-footer">Breathermae, Inc &copy; Copyright ' +
      year +
      '. All Rights Reserved.<br>Generated ' +
      esc(genStr) +
      '</div>';
    html +=
