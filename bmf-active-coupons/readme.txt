...
Adds the shortcode `[bmf_active_coupons]`.
...
1. Upload the `bmf-active-coupons` folder to `/wp-content/plugins/`
2. Activate the plugin
3. Create a page, add the shortcode `[bmf_active_coupons]`
